...
Category.find_by(name: "Low-Fi").activities.create(name: "Como House & Gardens", address: "Williams Road &, Lechlade Avenue, South Yarra VIC 3141", description: "The gardens at South Yarra’s historic Como House are a gorgeous spot to unwind. Grab a delish hamper from the Stables of Como and enjoy a lazy, weekend picnic. They're also home to the annual Paris to Provence Festival, which takes place every November. Bon appétit.", start_time: "2021-06-22"),
