...
Category.find_by(name: "Low-Fi").activities.create(name: "Happy Melon
", address: "1252 High Street, Armadale Victoria 3143", description: "Create a strong positive impact on your overall wellness and fall in love with the powerful combination of mindfulness and movement. Become a meditation teacher, expand your knowledge, learn from industry leaders. Grow and thrive as a teacher through teaching practice, attendance of in-studio shadow classes and personalised 1:1 mentoring sessions.", start_time: "2021-03-19")
]
