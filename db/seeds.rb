...
# Romance Category
romance_activties = [
Category.find_by(name: "Romance").activities.create(name: "Cute dinner with Thembi", address: "4/3 Murphy St, South Yarra VIC 3141", description: "Have a cute dinner with Thembi (pop the question at this romantic venue)", start_time: "2021-03-19", url:"https://www.youtube.com/playlist?list=UUZPQfUQNPZojG8DCdg8Mh9Q" ),
Category.find_by(name: "Romance").activities.create(name: "Married at first sight experience", address: "234 Elgar Rd, Box Hill South VIC 3128", description: "Show up, get married and see how you go.", start_time: "2021-03-19", url:"https://9now.nine.com.au/married-at-first-sight"),
Category.find_by(name: "Romance").activities.create(name: "Couples Olympics", address: "Melbourne Cricket Ground", description: "Bring your self and your partner and achieve couple greatness.", start_time: "2021-03-19", url:"https://www.pinterest.com.au/jessirose1/couples-olympics/"),
Category.find_by(name: "Romance").activities.create(name: "#InstaWorthy", address: "525 Collins St, Melbourne VIC", description: "Let us take you to all the most romantic locations in Melbourne so you can take memorable snaps with your partner", start_time: "2021-03-19", url:"https://www.instagram.com/explore/tags/instaworthy/?hl=en"),
Category.find_by(name: "Romance").activities.create(name: "Netflix and chill.. on a roof", address: "252 Swanston St, Melbourne VIC 3000", description: "Take your Netflix and chill game to the next level, literally. Enjoy the outdoor cinema on top or spend the night viewing the city lights.", start_time: "2021-03-19", url:"https://g.co/kgs/EjNxi5"),
Category.find_by(name: "Romance").activities.create(name: "The Colonial Tram Car Restaurant", address: "125 Normanby Road, South Melbourne, Victoria, 3205", description: "The Colonial Tramcar Restaurant is an elegant dining experience unique to Melbourne. Behold the sights as you comfortably cruise around the city while enjoying a seasonal menu and quality Australian wines from the all-inclusive bar. Choose between the luncheon four-course meal, early dinner three-course meal and late dinner five-course meal as well as pre-theatre dining.", start_time: "2021-03-19", url:"https://tramrestaurant.com.au/"),
...
Category.find_by(name: "Outdoorsy").activities.create(name: "Naked skydiving", address: "1421 Barwon Heads Rd, Connewarre VIC 3227", description: "Skydiving with clothes on is so mainstream.", start_time: "2021-03-19", url:"https://jointheteem.com/skydiving-videos/the-naked-news-goes-skydiving/"),
...
Category.find_by(name: "Outdoorsy").activities.create(name: "Amazing Race!", address: "Federation Square", description: "Expirience what it's like to be in the amazing race. Race around Melbourne solving clues and beating challenges.", start_time: "2021-03-19", url:"https://www.amazingracemelbourne.com.au/"),
Category.find_by(name: "Outdoorsy").activities.create(name: "Croajingolong", address: "W Wingan Rd, Wingan River Victoria 3891", description: "They say that good things come to those who wait. And while six hours may seem like a long time, it's well worth the road-trip for the swimming spot of your dreams. Grab a few mates, a tent and get ready to hit the beach. Spread across hundreds of kilometres in Gippsland, the Croajingolong National Park is beautifully wild. Think eucalypt forests leading to long, white sandy beaches. It's truly a secluded paradise and offers crystal clear waters ideal for snorkelling. Get ready to Instagram like crazy, or fully disconnect and make sandcastles on the beach instead.", start_time: "2021-03-19", url:"https://www.parks.vic.gov.au/places-to-see/parks/croajingolong-national-park"),
Category.find_by(name: "Outdoorsy").activities.create(name: "Half Moon Bay", address: "232 Beach Rd, Black Rock Victoria 3193", description: "Throw down your towel and get ready to frolic along this lunar-shaped beach and its luxurious sandy shores. Half Moon Bay is more for floating and bobbing than for surfing or getting dumped by waves. And that's a huge appeal when all you want is a leisurely day by the beach. For the rest of you, take a jaunt around the surrounding cliffs, where gorgeous coastal views await you. Once you're finished, head back to the beach where you can sink your toes in the sand and cool off with a dip. Then grab some fresh fish at one of Black Rock Wharf's seafood restaurants.", start_time: "2021-03-19", url:"https://www.bayside.vic.gov.au/facilities-venues/half-moon-bay-foreshore"),
Category.find_by(name: "Outdoorsy").activities.create(name: "Slumber Safari", address: "K Road, Werribee South VIC 3030", description: "Does a rhino get bed hair? Are giraffes grumpy in the morning? What does a lion eat for breakfast? Spend a night in your safari-styled tent fitted with all the creature comforts at the Werribee Open Range Zoo and find out all of these niggling questions that no amount of Googling can ever answer. Slumber Safari also includes delicious snacks, dinner, a night safari tour, campfire and the complimentary sparking wine. Plus an African-inspired brekkie the next morning on your own private deck.", start_time: "2021-03-19", url: "https://www.zoo.org.au/werribee/whats-on/animal-encounters/slumber-safari/"),
Category.find_by(name: "Outdoorsy").activities.create(name: "Cosy Tents", address: "6 Kanga Road, Yandoit, VIC 3461", description: "Goose down quilt? Check. Bose speakers? Check. Barbecue, esky and communal fire pit for adventurous campfire cooking? Check. Stunning views across Hepburn Shire? Yep — you guessed it — check. Cosy Tents is the perfect weekend getaway to explore the smorgasbord of gourmet food, wineries and award-winning restaurants in the region. Oh, and it's right near the spa capital of Australia. That's pretty handy too. Choose from a wide range of bell tents, all set with ample distance between them, but close enough to create a little glamping community, too.", start_time: "2021-03-19", url:"https://www.cosytents.com.au/"),
Category.find_by(name: "Outdoorsy").activities.create(name: "Puffing Billy", address: "1 Old Monbulk Road, Belgrave VIC 3160", description: "First launched in 1900, the Puffing Billy steam train was a low-cost way to open up remote areas. When a landslide blocked part of the track in 1953, a plan was made to close the line and a farewell day was organized. When 30,000 showed up to say goodbye, a dedicated group of train enthusiasts came together to save the Puffing Billy. It’s still chugging along today through Sherbrooke Forest in the beautiful Dandenongs.", start_time: "2021-03-19", url:"https://www.cosytents.com.au/"),
Category.find_by(name: "Outdoorsy").activities.create(name: "Healesvill Sanctuary", address: "Glen Eadie Avenue, Healesville Victoria 3777", description: "Depending on your source, between 80-90% of mammals living in Australia are found only here. And so, a visit to a wildlife sanctuary is a must-do when visiting this country. A sanctuary visit can be a full-day activity, but Gray Line has arranged it so you don’t miss a thing! Hop off the Gray Line bus and meet your Healesville Sanctuary volunteer. Their mission is to show you as much of this bushland haven is possible, so stick with them and you’ve got it made!", start_time: "2021-03-19", url:"https://www.zoo.org.au/healesville/getting-here"),
Category.find_by(name: "Outdoorsy").activities.create(name: "Sand Duning", address: "Glen Eadie Avenue, Healesville Victoria 3777", description: "Starting at Stockyard campsite near the entrance of Wilsons Promontory park, you can follow the signposts to the northern flank of Big Drift, an extensive series of very impressive inland sand dunes. The moderate walk is about 2 km (about 4km in total, counting the return). On the right-hand side of the Promontory Road, just after the Wilsons Promontory National Park entrance, you will find the Stockyard Campsite and the start of the walk. ", start_time: "2021-03-19", url:"https://puffingbilly.com.au/")
]

# Low-Fi Category
lowfi_activities = [
Category.find_by(name: "Low-Fi").activities.create(name: "Books & Wine", address: "111 Carlton St, Carlton", description: "Great wine and a great book is always a recipe for a perfect day", start_time: "2021-03-19"),
Category.find_by(name: "Low-Fi").activities.create(name: "Stargazing", address: "Great Otway National Park", description: "Walking, talking and stargazing at Great Otway National Park.", start_time: "2021-03-19"),
Category.find_by(name: "Low-Fi").activities.create(name: "Poetry night", address: "359 Little Bourke St, Melbourne", description: "Looking for a place to share and listen to poetry?", start_time: "2021-03-19"),
Category.find_by(name: "Low-Fi").activities.create(name: "Sunrise meditation", address: "Wilsons Promontory National Park", description: "Putting your mind at ease followed by a beautiful sunrise is a terrific way to begin your day.", start_time: "2021-03-19"),
Category.find_by(name: "Low-Fi").activities.create(name: "Board games night", address: "4/16 Fuller Rd, Ravenhall VIC 3023", description: "Great people and awesome board games. Nostalgia level 99.", start_time: "2021-03-19"),
Category.find_by(name: "Low-Fi").activities.create(name: "Hotbox Wednesdays", address: "1201 N La Brea Ave, West Hollywood, CA 90038, United States", description: "Hump days has been replaced with Hotbox Wednesday.", start_time: "2021-03-19"),
Category.find_by(name: "Low-Fi").activities.create(name: "Onsen Ma Japanese Bathhouse", address: "12-18 Meyers Place, Melbourne VIC 3000", description: "Wash your worries away at this traditional Japanese bathhouse in the CBD. Onsen Ma is a little slice of heaven where you can soak in private or public baths, or bliss out with a shiatsu massage.", start_time: "2021-03-19"),
Category.find_by(name: "Low-Fi").activities.create(name: "Reading Room at the State Library", address: "328 Swanston Street, Melbourne VIC 3000", description: "Flex your brain power under the iconic glass dome of the State Library’s La Trobe Reading Room. A popular tourist attraction, it might not be a cone of silence these days, but it will soothe the soul of anyone feeling studious.", start_time: "2021-03-19"),
Category.find_by(name: "Low-Fi").activities.create(name: "Gravity Floatation", address: "559 High Street, Northcote Victoria 3070", description: "Being alone, naked, in darkness and silence, floating in an Epsom Salt bath in an enclosed pod might sound kinda creepy. But you’d be hella surprised how relaxing this meditative experience is.", start_time: "2021-03-19"),
