...
Category.find_by(name: "Outdoorsy").activities.create(name: "Puffing Billy", address: "1 Old Monbulk Road, Belgrave VIC 3160", description: "First launched in 1900, the Puffing Billy steam train was a low-cost way to open up remote areas. When a landslide blocked part of the track in 1953, a plan was made to close the line and a farewell day was organized. When 30,000 showed up to say goodbye, a dedicated group of train enthusiasts came together to save the Puffing Billy. It’s still chugging along today through Sherbrooke Forest in the beautiful Dandenongs.", start_time: "2021-03-12", url:"https://www.cosytents.com.au/"),
...
Category.find_by(name: "Low-Fi").activities.create(name: "Edinburgh Gardens
", address: "Alfred Cresent, Fitzroy North Victoria 3068", description: "Laze around in the company of Fitzroy’s hipsters at Edinburgh Gardens. Located in North Fitzroy, the 59 acres park has open lawn areas where you can kick a footy around and is shaded by large trees making it the ideal place to shake out a rug.", start_time: "2021-03-19"),
